...
const stages: { id: Stage; label: string; color: string; bg: string }[] = [
  ...
  { id: "contacted", label: "Contact Attempted", color: "#0284C7", bg: "#EFF6FF" },
  { id: "qualified", label: "Qualified", color: "#7C3AED", bg: "#F5F3FF" },
  { id: "site_visit", label: "Site Visit", color: "#D97706", bg: "#FFFBEB" },
  { id: "estimate_sent", label: "Estimate Sent", color: "#EA580C", bg: "#FFF7ED" },
  { id: "negotiation", label: "Negotiation", color: "#DC2626", bg: "#FEF2F2" },
...
function LeadCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 4px 12px rgba(46,125,50,0.12)";
    ...
    >
      ...
      <div
        ...
        style={{ fontSize: "15px", fontWeight: 700, color: "var(--brand-green)" }}
      >
      ...
      <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: "var(--border)" }}>
        <div className="flex items-center gap-1.5">
          <div
            ...
            style={{ backgroundColor: "var(--brand-green)", fontSize: "9px", fontWeight: 700 }}
          >
            {lead.repInitials}
          </div>
          <span style={{ fontSize: "11px", color: "var(--muted-foreground)" }}>{lead.rep}</span>
        </div>
        <span style={{ fontSize: "10px", color: "var(--muted-foreground)" }}>{lead.lastActivity}</span>
      </div>
      ...
      {lead.daysInStage > 5 && (
        ...
        >
          <AlertCircle className="w-3 h-3" style={{ color: "var(--status-orange)" }} />
          <span style={{ fontSize: "10px", color: "var(--status-orange)", fontWeight: 500 }}>
...
export function PipelineBoard({ onAddLead }: PipelineBoardProps) {
  const navigate = useNavigate();
  const { leads: crmLeads, updateLeadPipelineStage } = useLeads();
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Toolbar */}
      <div className="flex items-center gap-3 px-6 py-4 bg-white border-b" style={{ borderColor: "var(--border)" }}>
        ...
        <button className="flex items-center gap-1.5 px-3 py-2 border rounded-lg hover:bg-muted" style={{ fontSize: "13px", borderColor: "var(--border)" }}>
        ...
        <div className="ml-auto flex items-center gap-2 px-4 py-2 rounded-lg" style={{ backgroundColor: "var(--brand-light-green)" }}>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: stage.color, fontSize: "10px", fontWeight: 700 }}
                    >
                      {cards.length}
                    </div>
                  </div>
                ...
                <div className="flex-1 p-3 space-y-2.5 overflow-y-auto">
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLButtonElement).style.backgroundColor = stage.bg;
                    }}
                    onMouseLeave={(e) => {
