...
const tasks: Task[] = [
  {
    ...
    status: "pending",
    type: "call",
    description: "Customer wants to discuss pricing on drainage system. Has military discount query.",
  },
  {
    id: "2",
    title: "Send revised quote to Riverside HOA",
    lead: "Riverside HOA",
    assignee: "Emily C.",
    assigneeInitials: "EC",
    due: "Today 5:00 PM",
    ...
    status: "pending",
    type: "quote",
    description: "Include Phase 2 option and financing terms per board request.",
  },
  {
    id: "3",
    title: "Site visit — Martinez Residence",
    lead: "Martinez Residence",
    assignee: "Alex J.",
    assigneeInitials: "AJ",
    ...
    status: "overdue",
    type: "visit",
    description: "Measure backyard. Confirm drainage direction. Discuss dog-friendly options.",
  },
  {
    id: "4",
  ...
  {
    id: "5",
    title: "Schedule consultation — Desert Vista HOA",
  ...
  {
    id: "6",
    title: "Follow up with Greenway Commons re: approval",
  ...
  },
  {
    ...
    status: "pending",
    type: "other",
    description: "Legal team has flagged Section 4.2 warranty clause.",
  },
  {
    id: "8",
  ...
  {
    id: "10",
    title: "Schedule site visit for Thornton Family",
