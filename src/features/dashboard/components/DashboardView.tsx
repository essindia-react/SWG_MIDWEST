...
const recentActivities = [
  { id: 1, type: "call", user: "Maria S.", lead: "Henderson Estate", time: "8m ago", detail: "Proposal follow-up call completed" },
  { id: 2, type: "email", user: "Chris W.", lead: "Rivera Pool & Turf", time: "23m ago", detail: "Sent hardscape estimate — $62,000" },
  { id: 3, type: "note", user: "Chris W.", lead: "Park Estates Dev.", time: "1h ago", detail: "Board reviewing putting green proposal" },
  { id: 4, type: "won", user: "Chris W.", lead: "Sunbelt Properties", time: "2h ago", detail: "Deal closed — $72,000" },
];

const upcomingTasks = [
  { id: 1, title: "Call back Henderson re: pricing", due: "Today 2:00 PM", priority: "high", lead: "Henderson Estate" },
  { id: 2, title: "Follow up with Park Estates", due: "Jun 7, 11:00 AM", priority: "medium", lead: "Park Estates Dev." },
  { id: 3, title: "Rivera estimate review call", due: "Jun 7, 3:00 PM", priority: "medium", lead: "Rivera Pool & Turf" },
  { id: 4, title: "Review installation plans", due: "Jun 8, 3:00 PM", priority: "low", lead: "Sunbelt Properties" },
];
